...
public class ClassicGui extends VBox implements CountTime {
	private Button startGameButton;
	private Label countdownLabel;
	private Classic targetClassic;

	private Boolean isFirstClick = true;

	public ClassicGui(Classic targetClassic) {
		this.setPrefHeight(Config.screenHeight);
		this.setPrefWidth(Config.screenWidth);
		this.targetClassic = targetClassic;
		...
		this.setOnMouseClicked(event -> {
			if (isFirstClick) {
				...
				this.targetClassic.setCursor(Cursor.CROSSHAIR);
	...
	public void startCount() {
		...
		timeline.setOnFinished(event -> {
			this.targetClassic.getChildren().remove(this);
			this.targetClassic.gameStart();
			this.targetClassic.getCountDownPane().startCount();
